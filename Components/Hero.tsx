  ...
  return (
    <div className="h-[88vh] bg-[url(/images/banner.jpg)] bg-cover bg-center ">
      ...
      <div className="w-[80%] grid-cols-1 mx-auto grid lg:grid-cols-2 gap[3rem] h-[100%] items-center">
        ...
        <div className="w-[300px] hidden bg-[55e6a5] relative lg:flex ml-[10rem] items-center rounded-full h-[300px]">
          <img src="images/profile.jpg" alt="user" layout="fill" className="object-cover rounded-full" />
        </div>
