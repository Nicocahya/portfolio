  ...
  return (
    <div className="flex flex-col text-center justify-center">
        ...
        <p className='text-[16px] text-white opacity-50 w-[90%] md:w-[50%] mx-auto'>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Nulla rem ut eos dolore saepe possimus facere ipsum natus quidem expedita cumque eveniet impedit quos ratione repellendus rerum, necessitatibus nostrum neque!
        </p>
    </div>
  )
}
