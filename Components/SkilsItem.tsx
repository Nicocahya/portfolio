  ...
  return (
    <div className="mb-[4rem] md:mb-[8rem]">
      ...
      <p className="text-[#aaaaaa] font-normal w-[80%]  text-[17px] opacity-80">
        Lorem ipsum dolor sit amet consectetur, adipisicing elit. Earum alias qui, nesciunt, recusandae officiis, sint odio corrupti autem consequuntur asperiores deserunt nobis veniam voluptatibus eaque.
      </p>
    </div>
  );
};
